...
echo '
  ...
  <form class="form" role="form" name="seachform" method="post" id="form" action="envia_edit.php " >
      ...
      <input type="text" class="form-control" id="nome" name="nome"   value="'.$lin_dado_cli['nome'].'" required   >
    </div>
      ...
      <input type="text" class="form-control" id="endereco" name="endereco"   value="'.$lin_dado_cli['endereco'].'" required  >
    </div>
     
      <div class="form-group">

       <label for="email">BAIRRO:</label>
      <input type="text" class="form-control" id="bairro" name="bairro"  value="'.$lin_dado_cli['bairro'].'" required  >
    </div>
    
      <div class="form-group">

       <label for="email">CONTATO:</label>
      <input type="text" class="form-control" id="contato" name="contato"  value="'.$lin_dado_cli['contato'].'"  required   >
    </div>
    
      <div class="form-group">

       <label for="email">MODELO VEÍCULO:</label>
      <input type="text" class="form-control" id="mod_vei" name="mod_vei"   value="'.$lin_dado_cli['mod_vei'].'" required  >
    </div>
   
      <div class="form-group">

       <label for="email">ANO VEÍCULO:</label>
      <input type="text" class="form-control" id="ano_vei" name="ano_vei" value="'.$lin_dado_cli['ano_vei'].'"  required  >
    </div   >   
