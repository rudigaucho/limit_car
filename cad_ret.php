...
con_consulta.open("GET","processar_ret.php?cpf="+cpf,true);
...
function loginsuccessfully()
{
  ...
  <title>CADASTRO DE RETIRADA LIMIT CAR</title>
  <meta charset="utf-8">
...
<div class="navbar navbar-inverse navbar">
    ...
    <div class="container">
 <span><strong>CADASTRO DE RETIRADA</strong></span>
  ...
  <form class="form" role="form" name="seachform" method="post" id="form" action="enviar_ret.php " >
