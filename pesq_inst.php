...
$sql = mysql_query ("select data_ins,cpf,cod_ins,cliente.cod_cli,nome,uf,contato,mod_vei,ano_vei,instalacao.status from instalacao join cliente on instalacao.cod_cli=cliente.cod_cli where cliente.cpf = '$cpf';" );
